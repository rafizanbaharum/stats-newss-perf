 ...
 * @since 9/5/13
 */
@Entity(name = "LongColumnModel")
@Table(name = "LCM")
public class LongColumnModel implements Serializable {

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SEQ_LCM")
    @SequenceGenerator(name = "SEQ_LCM", sequenceName = "SEQ_LCM", allocationSize = 1)
    private Long id;
    @Column
